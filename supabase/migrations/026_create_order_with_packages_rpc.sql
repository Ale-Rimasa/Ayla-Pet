-- ============================================================
-- 026_create_order_with_packages_rpc.sql
-- Extiende create_order para incluir el snapshot de bultos
-- dentro de la misma transacción atómica.
-- p_shipping_packages: JSONB array de bultos, cada uno con:
--   { package_profile_id, bulto_index, weight_g, height_mm, width_mm, length_mm }
-- El array vacío es válido (retiro presencial sin Andreani).
-- ============================================================
...
GRANT EXECUTE ON FUNCTION public.create_order(text, text, text, text, text, text, text, integer, integer, integer, text, jsonb, uuid, jsonb) TO service_role;
